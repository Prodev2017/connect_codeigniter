        ...
        EmailBuilder.prototype = {
            ...
            generate: function(elementsHtml) {
                ...
                _outputContent = '<div class="bal-content">' +
                    ...
                    '<div class="bal-content-main lg-width"><div class="page">' +
                    '' +
                    _loadPageHtml +
                    '' +
                    '</div>' +
            ...
            events: function() {
                ...
                _this.$elem.find('.blank-page').on('click', function() {
                    ...
                    swal({
                        ...
                        _this.$elem.find('.bal-content-main').html('<div class="page"><div class="email-editor-elements-sortable">' +
                ...
                _this.$elem.find(".bal-elements-list .bal-elements-list-item").draggable({
                    ...
                    drag: function(event, ui) {
                        ...
                        var height = 0;
                        $( ".page .bal-elements-list-item" ).each(function() {
                        height = height + $( this ).height();
                        });
                        $( ".page .sortable-row" ).each(function() {
                        height = height + $( this ).height();
                        });

                        if (height > 1600) {

                        	alert ('Page full, please create a new one.');
                        	$('.email-editor-elements-sortable .bal-elements-list-item:last').remove();
                        	return false;
            ...
            getContentHtml: function() {
                ...
                _result = '<div width="100%" cellspacing="0" cellpadding="0" border="0" style="' + _style + '"><div><div><div><div style="margin:0 auto;width:' + _width + ';' + _padding + '">' + _html + '</div></div></div></div>';
                return _result;
            },
            /**
                    ...
                    success: function(data) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            for (var j = 0; j < _items.length; j++) {
                            	...
                            	if (_items[j].name != 'Image left text') {
                            	if (_items[j].name != '2 column text') {
                            	if (_items[j].name != 'Image right text') {
                            		if (_items[j].name != 'Price table') {
                                _outputHtml += '<li>' +
