<aside class="desktop">
    ...
    <?php if($other_contacts):?>
        <div class="meta-block <?php if(($this->uri->segment(1)=="connection")||($this->uri->segment(1)=="enquiries")){echo 'bd-blue';}
                ...
                <?php foreach($other_contacts as $other):?>
                    <span><a href="<?php echo base_url().'contacts/add_opportunity/'.$other->id;?>"><?php echo $other->first_name.' '.$other->last_name;;?></a></span><br>
                <?php endforeach;?>
        </div><!-- end of meta-block -->
    <?php endif;?>
